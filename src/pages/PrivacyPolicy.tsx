      ...
      <main className="container mx-auto px-4 pt-24 pb-16">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mt-8 space-y-2">
            ...
            <p className="text-muted-foreground">
              For privacy-related queries, contact us at <a href="mailto:contact.ranklao@gmail.com" className="text-primary">contact.ranklao@gmail.com</a> or visit our <a href="/contact" className="text-primary">Contact Us</a> page.
            </p>
          </section>
        </div>
      </main>
